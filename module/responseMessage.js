module.exports = {//서버들끼리의 원활한 소통을 위해서 응답메세지를 통일
    ...
    GET_MAIN_SUCCESS: "main 카테고리 부르기 성공",
    GET_LEVEL_SUCCESS: "level 불러오기 성공",
    GET_LEVEL_FAIL: "level 불러오기 실패",
    GET_QUIZ_SUCCESS: "quiz 불러오기 성공" ,
    GET_QUIZ_FAIL: "quiz 불러오기 실패",
    GET_VOCA_SUCCESS: "voca 불러오기 성공",
    GET_VOCA_FAIL: "voca 불러오기 실패",
